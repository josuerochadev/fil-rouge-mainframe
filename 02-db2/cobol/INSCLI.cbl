      ...
      *---------------------------------------------------------
      * PROGRAMME : INSCLI
      * FONCTION  : Insertion d'un nouveau client en base DB2
      * TABLE     : CLIENT (INSERT avec COMMIT/ROLLBACK)
      * ENTREE    : Donnees client via SYSIN (JCL In-Stream)
      * TECHNIQUE : SQL embarque, conversion NUMVAL, gestion
      *             transactionnelle avec COMMIT/ROLLBACK
      *---------------------------------------------------------
