      ...
      *---------------------------------------------------------
      * PROGRAMME : LSTRUPT
      * FONCTION  : Liste des clients avec ruptures multi-niveaux
      * TABLES    : CLIENT, REGION, PROFESSI (jointures)
      * TECHNIQUE : CURSOR DB2 avec INNER JOIN, detection de
      *             ruptures sur region et profession
      * TRI       : CODE_REGION, CODE_PROF, NUM_COMPTE
      *---------------------------------------------------------
