      ...
      *---------------------------------------------------------
      * PROGRAMME : RELEVE
      * FONCTION  : Releve de compte d'un client avec mouvements
      * TABLES    : CLIENT, MOUVEMENT
      * TECHNIQUE : CURSOR DB2, FETCH avec edition CR/DB
      * ENTREE    : Numero de compte (ACCEPT)
      *---------------------------------------------------------
       ...
       2000-RECUPERER-CLIENT.
           ...
           EVALUATE SQLCODE
               ...
               WHEN 100
                   ...
                   STOP RUN
               WHEN OTHER
                   DISPLAY 'ERREUR SQL SELECT CLIENT : ' SQLCODE
                   PERFORM 9000-FIN
                   STOP RUN
           END-EVALUATE.
