...
PROGRAMS = {
    "PJ10ACT": {
        ...
        "description": "Exo 10 — Liste via AIX Activite (05=Medecin, 10=Ingenieur, 15=Comptable, 20=Commercant, 25=Fonctionnaire, 30=Privee)",
        "input": None,
        "phase": "batch",
    },
    "PJ10REG": {
        "name": "Edition par region",
        "description": "Exo 10 — Liste via AIX Region (01=Grand-Est, 02=Ile-de-France, 03=Normandie, 04=Bretagne)",
        "input": None,
        "phase": "batch",
    },
    "PJ14MAIN": {
        "name": "Tables de reference",
        "description": "Exo 14 — Edition des 3 tables de reference via CALL sous-programmes (ADVANCING PAGE/LINE)",
        "input": None,
        "phase": "batch",
    },
    "PJ15MONT": {
        "name": "Montants et moyennes",
        "description": "Exo 15 — Montant general et moyenne des comptes debiteurs et crediteurs",
        "input": None,
        "phase": "batch",
    },
    "PJ16COND": {
        "name": "Analyse par region",
        "description": "Exo 16 — Valeur des comptes DB/CR par region avec variables conditionnelles (niveau 88)",
        "input": None,
        "phase": "batch",
    },
    "PJ17TOP5": {
        "name": "Top 5 debiteurs",
        "description": "Exo 17 — Les 5 premiers clients debiteurs en valeur (SORT DESCENDING)",
        "input": None,
        "phase": "batch",
    },
    "PJ19MOMT": {
        "name": "Mouvements client",
        "description": "Exo 19 — Montant et nombre de mouvements d'un client (ACCEPT + SORT interne)",
        "input": "Numero de compte (001-020)",
        "phase": "batch",
    },
    "PJ20RLV": {
        "name": "Releve de compte",
        "description": "Exo 20 — Releve de compte avec detail des operations triees par date",
        "input": "Numero de compte (001-020)",
        "phase": "batch",
    },
    "PJ21MERG": {
        "name": "Fusion trimestrielle",
        "description": "Exo 21 — Fusion MERGE de 3 mois de mouvements (Janvier, Fevrier, Mars)",
        "input": None,
        "phase": "batch",
    },
}
