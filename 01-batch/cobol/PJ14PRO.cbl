      ...
      *================================================================*
      * PROGRAMME : PJ14PRO
      * FONCTION  : Sous-programme d'edition de la table des
      *             activites professionnelles (KSDS PROFES)
      * TECHNIQUE : GOBACK, OPEN EXTEND sur fichier d'edition
      * ENTREE    : Fichier PROFES indexe (PROFES.ix)
      * SORTIE    : Fichier d'edition partage (EDITION.txt)
      *================================================================*
