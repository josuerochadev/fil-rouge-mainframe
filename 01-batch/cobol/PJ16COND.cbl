      ...
      *================================================================*
      * PROGRAMME : PJ16COND
      * FONCTION  : Repartition debit/credit par region avec
      *             totalisation par zone geographique
      * TECHNIQUE : Niveaux 88 pour regions et positions,
      *             EVALUATE TRUE pour dispatch par region
      * ENTREE    : Fichier CLIENT sequentiel (CLIENT.dat)
