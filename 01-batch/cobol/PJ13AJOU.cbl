      ...
      *================================================================*
      * PROGRAMME : PJ13AJOU
      * FONCTION  : Ajout d'un nouveau client dans le fichier
      *             KSDS CLIENT (acces direct par cle)
      * TECHNIQUE : OPEN I-O, WRITE avec controle FILE STATUS
      *             (duplicat, erreur ecriture)
      * ENTREE    : Donnees en dur dans WORKING-STORAGE
      * SORTIE    : Fichier CLIENT indexe (CLIENT.ix)
      *================================================================*
