      ...
      *================================================================*
      * PROGRAMME : PJ19MOMT
      * FONCTION  : Resume des mouvements d'un client (nombre,
      *             totaux credits/debits, solde mouvements)
      * TECHNIQUE : ACCEPT SYSIN, SORT ASCENDING par date,
      *             INPUT/OUTPUT PROCEDURE avec filtrage compte
      * ENTREE    : Fichier MOUVEMENT.dat + numero de compte
