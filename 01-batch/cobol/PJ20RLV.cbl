      ...
      *================================================================*
      * PROGRAMME : PJ20RLV
      * FONCTION  : Edition d'un releve de compte client avec
      *             detail des mouvements tries par date
      * TECHNIQUE : ACCEPT SYSIN, READ RANDOM sur CLIENT.ix,
      *             SORT ASCENDING par date sur MOUVEMENT.dat
      * ENTREES   : CLIENT.ix (indexe) + MOUVEMENT.dat + numero
