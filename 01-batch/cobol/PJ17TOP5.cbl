      ...
      *================================================================*
      * PROGRAMME : PJ17TOP5
      * FONCTION  : Classement des 5 plus gros clients debiteurs
      *             tries par solde decroissant
      * TECHNIQUE : SORT DESCENDING avec INPUT/OUTPUT PROCEDURE,
      *             filtrage par position DB, RETURN limite a 5
